...
class LanguageProvider with ChangeNotifier {
  ...
  Map<String, Object> textsAr = {
    'all_food':"جميع المأكولات",
    "add_to_favorate": "مفضلة",
    "start": "أبدأ الان",
    "connect_with_us": "تواصل معنا",
    "your_meals": "وجباتك",
    "welcome": "مرحبا",
    "drawer_name": "عالم المطبخ",
    ...
    "ingredients-m9": [
      ...
      "2 أوقية  شوكولاتة داكنة ، مقطعة إلى قطع",
      "1 ملعقة كبيرة زبدة",
    ...
    "steps-m3": [
      "فطائر شكل 2",
      "  تقلى الفطائر   4 دقائق على كل جانب ،",
      "اقلي الكعك بسرعة دقيقة واحدة على كل جانب ،",
